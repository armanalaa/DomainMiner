...
summary Excel file to the project root.
...
-----
  ...
  python list_derived_weights.py --output results/weights.xlsx

  # Include only specific datasets
  python list_derived_weights.py --datasets Sakila Northwind Chinook
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=Path, default=Path("derived_weights_summary.xlsx"),
        help="Output Excel file path (default: derived_weights_summary.xlsx)"
    )
    parser.add_argument(
